...
function tt({
  ...
  const n = () => {
    ...
    if (c && s < d && (z || l.slice(0, S).every((m, v) => {
      const b = h[v];
      return (b == null ? void 0 : b.collapsible) && I(b.collapsedSize, u[b.panelId]);
    }))) {
...
function Ut({
  ...
  const z = (0, import_react.useRef)({
    ...
    W(z.current.onLayoutChange, x) || (z.current.onLayoutChange = x, s == null ? void 0 : s(x));
  }), p = se((x) => {
    W(z.current.onLayoutChanged, x) || (z.current.onLayoutChanged = x, l == null ? void 0 : l(x));
